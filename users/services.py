...
#         raise UserAlreadyExists(f"User {first_name} {last_name} ({username}) already exists.")
#
#     user = User.objects.create_superuser(username=username, first_name=first_name, last_name=last_name, email=email)
...
#         profile__admin_profile__isnull=True
#     )
#     return employees
#
#
...
#         profile__employee_profile__isnull=True,
#         profile__customer_profile__isnull=True,
#         profile__admin_profile__isnull=False
#     )
#     return owner
